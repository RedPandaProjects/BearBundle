...
void CompressBlocksBC1(const rgba_surface* src, uint8* dst)
{
	CompressBlocksBC1_ispc((rgba_surface*)src, dst);
}

void CompressBlocksBC3(const rgba_surface* src, uint8* dst)
{
	CompressBlocksBC3_ispc((rgba_surface*)src, dst);
}

void CompressBlocksBC7(const rgba_surface* src, uint8* dst, bc7_enc_settings* settings)
{
	CompressBlocksBC7_ispc((rgba_surface*)src, dst, (bc7_enc_settings*)settings);
}

void CompressBlocksBC6H(const rgba_surface* src, uint8* dst, bc6h_enc_settings* settings)
{
    CompressBlocksBC6H_ispc((rgba_surface*)src, dst, (bc6h_enc_settings*)settings);
}

void CompressBlocksETC1(const rgba_surface* src, uint8* dst, etc_enc_settings* settings)
{
    CompressBlocksETC1_ispc((rgba_surface*)src, dst, (etc_enc_settings*)settings);
}
